    ...
    <div className="flex flex-col-reverse md:flex-row py-8">
      <Section className="md:px-10 md:pt-10">
        <CustomLink href={"/projects"} noblank>
          <StandardButton
            prependChild={<RightArrow className="rotate-180"></RightArrow>}
          >
            Back to projects
          </StandardButton>
        </CustomLink>
          ...
          <SubSection>
            ...
            <div className="flex flex-row flex-wrap w-full mt-1">
              {projectData.tags.map((t, i) => (
                <ProjectTag key={i} tag={t} className="mr-2 my-1"></ProjectTag>
              ))}
            </div>
          </SubSection>
          ...
          {projectData.client && (
            <SubSection className="mt-5">
              ...
              {projectData.client?.map((c, i) => (
                <AvatarTag bg={c.bg} src={c.img} href={c.link} key={i}>
                  {c.name}
                </AvatarTag>
              ))}
            </SubSection>
            ...
            <div>
              {projectData.link && (
                <SubSection className="mt-5">
                  ...
                  <CustomLink href={projectData.link} decoration>
                    Visit the project
                  </CustomLink>
                </SubSection>
              )}
              {projectData.repository && (
                <SubSection className="mt-5">
                  ...
                  <CustomLink href={projectData.repository} decoration>
