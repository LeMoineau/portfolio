...
export default function AboutCard() {
  return (
    <>
      ...
      <h3 className="font-medium text-lg text-center mt-4">Pierre Faber.</h3>
      ...
      <CustomList>
        <PillListItem entitle="Location" content="On Remote"></PillListItem>
        <PillListItem entitle="Availability" content="Now"></PillListItem>
        <PillListItem
          entitle="Email"
          content={
